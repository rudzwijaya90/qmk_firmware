...
#define TTLESC        LT(_RAISE, KC_ESC)
...
[_QWERTY] = LAYOUT_ortho_4x12(
   ...
   TTLESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
...
[_COLEMAK] = LAYOUT_ortho_4x12(
  ...
  TTLESC,  KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT,
...
[_DVORAK] = LAYOUT_ortho_4x12(
  ...
  TTLESC,  KC_A,    KC_O,    KC_E,    KC_U,    KC_I,    KC_D,    KC_H,    KC_T,    KC_N,    KC_S,    KC_SLSH,
...
[_RAISE] = LAYOUT_ortho_4x12(
  ...
  KC_DEL,   _______, KC_UP,   _______,   KC_WH_U,  KC_PGUP,  _______,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
  _______,  KC_LEFT, KC_DOWN, KC_RIGHT,  KC_WH_D,  KC_PGDN,  _______,  KC_NUHS, KC_NUBS, _______, _______, KC_PSCR,
...
[_ADJUST] =  LAYOUT_ortho_4x12(
  QK_BOOT, _______, _______, _______, _______, _______, _______, _______, _______, _______,  KC_PWR,  KC_DEL,
